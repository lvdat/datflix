    ...
    <template v-if="currentAction === 'manager'">
        <div class="card mb-3 card-button">
            <div class="card-body text-center">
                <button @click="changeAction('create')" type="button" class="btn btn-success"><i class="fas fa-plus"></i> Thêm quốc gia</button>
                <button @click="getCountries()" class="btn btn-warning reload-button"><i class="fas fa-rotate-right"></i> Làm mới</button>
            </div>
        </div>
